...
def entropic_otc(Px, Py, c, L=100, T=100, xi=0.1, sink_iter=100, method='logsinkhorn', reg_num=None, get_sd=False):
    """
    ...
    while g_old[0] - g[0] > tol:
        ...
        P = entropic_tci(h=h, P0=P_old, Px=Px, Py=Py, xi=xi, sink_iter=sink_iter, solver_fn=solver_fn)
